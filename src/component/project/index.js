        ...
        <ul className="feature-list" >
          ...
          > 
            ...
            <section>
              ...
              You create a room, invite others too it and send out a
              question to get responses from the voters.

              It was built with the idea of giving teachers instant feedback
              from the students on topics that were covered in the class.
              Firepolls also allows a poll creator to save their polls for reference
              to keep track of how the opinions change.

              Main Technologies: JavaScript, Socket IO, Babel, MongoDB,
              Heroku & Continuous Deployment, Travis Continuous Integration,
              React, Redux,Material UI, Artillery (Load Testing),
              Jest (Test Driven Development),
              Webpack, Express, Node. */}
              </p>
            </section>
          </li>
          {/* TODO: Put repeating code into a map fo reach <li> */}
          <li 
            className="feature"
            id="featureTwo"
          ...
          > 
            <svg className="icons icons-stats-bars" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
              ...
              {/* <path d="M0 39h48v6h-48zM6 27h6v9h-6zM15 15h6v21h-6zM24 24h6v12h-6zM33 6h6v30h-6z" /> */}
            </svg>
            <section>
              <h3> Real Time Data </h3>
              <p>
                Visualize results in real time and easily know where the audience stands on any topic at any time.
              </p>
            </section>
          </li>
