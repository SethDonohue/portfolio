      ...
      <Fragment>
        <div className="landing-frag">
          <section className="intro" >
            ...
            <p id="intro-p-thanks"> Thanks for checking out my portfolio.</p>
            <p id="intro-p-developed">It is being developed with ReactJS, Node.js, Babel, Webpack and SaSS.</p>
            <p id="intro-p-look">Take a look at the projects below to see a summary of their technologies and features.</p>
