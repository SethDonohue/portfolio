...
// Image import
import sethHeadShot from '../../image/IntroSeth-TransparentCropped.png';
          ...
          <section className="intro" >
            ...
            */}
            <section className="intro-content">
              <article id="intro-left">
                <p id="left-p-1">
                  Hello and welcome.
                </p>
                <p id="left-p-2">
                  I make web applications, usually in Node, and with React.
                </p>
                <p id="left-p-3">
                  I&apos;m a Full Stack Developer and Programmer living in Seattle.
                </p>
                <p id="left-p-4">
                  {/* I enjoy the outdoors, backpacking around the world,<br /> and building things in the physical & virtual realms. <br />Especially those last two together. */}

                  When not coding, I&apos;m exploring something new, often in the physical world of electronics, mechanical systems, or astronomy.
                </p>

              </article>
              <article id="intro-right">
                <img src={sethHeadShot} alt="Seth head shot" />
